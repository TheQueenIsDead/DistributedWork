"""
Django settings for DistributedWork project.
...
SECRET_KEY = 'mfxvjj1xv-^&5*eo6p=*%=$=k2l_fycp5g=jzdute7dtwn)o^h'
...
ROOT_URLCONF = 'DistributedWork.urls'
...
WSGI_APPLICATION = 'DistributedWork.wsgi.application'
